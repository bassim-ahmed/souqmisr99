<nav class="navbar bg-dark navbar-dark ">  
  ...
  <ul class="nav justify-content-end">
				<li class="nav-item">
				  <a class="nav-link active text-white" href="{{route('user.orders')}}">My orders</a>
                  @if($order->status == 'ordered')
                  <a class="nav-link active text-white" href="#" wire:click.prevent="cancelOrder">Cancel Order</a>
                  @endif
				</li>
			  </ul>
</nav>
